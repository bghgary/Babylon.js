...
//             bufferView = createBufferView(0, binaryWriter.getByteOffset(), byteLength, undefined, `${name}  keyframe data view`);
...
//             bufferView = createBufferView(0, binaryWriter.getByteOffset(), byteLength, undefined, `${name}  data view`);
//             bufferViews.push(bufferView);
...
//             accessor = createAccessor(bufferViews.length - 1, `${name}  data`, dataAccessorType, AccessorComponentType.FLOAT, outputLength, null, null, null);
//             accessors.push(accessor);
